...
function Client(options) {
  ...
  self.name = null;
  self.position = {x: -10000, y: -10000}; // 10/10 best programming
  ...
  self.connection.on('message', function(data) {
    ...
    switch (message.type) {
      case 'move':
        ...
        // FIXME  what were you thinking
        self.game.names[self.name].velocity = self.velocity;
...
Client.prototype._applyRegex = function(message) {
  var self = this;
  // remove whitespace
